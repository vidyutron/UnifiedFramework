...
namespace Newtonsoft.Json.Linq.JsonPath
{
	internal class JPath
	{
		...
		private void ParseMain()
		{
			...
			{
				this._currentIndex++;
				this.EnsureLength("Unexpected end while parsing path.");
				if (this._expression[this._currentIndex] != '.')
				{
					throw new JsonException("Unexpected character while parsing path: " + this._expression[this._currentIndex]);
				}
