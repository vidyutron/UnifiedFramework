...
namespace OpenQA.Selenium.Remote
{
	public sealed class WebDriverWireProtocolCommandInfoRepository : CommandInfoRepository
	{
		...
		protected override void InitializeCommandDictionary()
		{
			...
			base.TryAddCommand(DriverCommand.GetCurrentWindowHandle, new CommandInfo("GET", "/session/{sessionId}/window_handle"));
			base.TryAddCommand(DriverCommand.GetWindowHandles, new CommandInfo("GET", "/session/{sessionId}/window_handles"));
			...
			base.TryAddCommand(DriverCommand.ExecuteScript, new CommandInfo("POST", "/session/{sessionId}/execute"));
			base.TryAddCommand(DriverCommand.ExecuteAsyncScript, new CommandInfo("POST", "/session/{sessionId}/execute_async"));
			...
			base.TryAddCommand(DriverCommand.GetElementSize, new CommandInfo("GET", "/session/{sessionId}/element/{id}/size"));
			base.TryAddCommand(DriverCommand.GetElementValueOfCssProperty, new CommandInfo("GET", "/session/{sessionId}/element/{id}/css/{propertyName}"));
			...
			base.TryAddCommand(DriverCommand.GetWindowSize, new CommandInfo("GET", "/session/{sessionId}/window/{windowHandle}/size"));
			base.TryAddCommand(DriverCommand.SetWindowSize, new CommandInfo("POST", "/session/{sessionId}/window/{windowHandle}/size"));
			...
			base.TryAddCommand(DriverCommand.MaximizeWindow, new CommandInfo("POST", "/session/{sessionId}/window/{windowHandle}/maximize"));
			...
			base.TryAddCommand(DriverCommand.DismissAlert, new CommandInfo("POST", "/session/{sessionId}/dismiss_alert"));
			base.TryAddCommand(DriverCommand.AcceptAlert, new CommandInfo("POST", "/session/{sessionId}/accept_alert"));
			base.TryAddCommand(DriverCommand.GetAlertText, new CommandInfo("GET", "/session/{sessionId}/alert_text"));
			base.TryAddCommand(DriverCommand.SetAlertValue, new CommandInfo("POST", "/session/{sessionId}/alert_text"));
